...
const _print = function(message) {
  ...
  for (let i = 0; i < arguments.length; i++) {
    if (typeof arguments[i] == 'object') {
      ...
      logger2.innerHTML += arguments[i] + '<br />'
    }
  }
}
...
const _print_bold = function(message) {
  ...
  for (let i = 0; i < arguments.length; i++) {
    if (typeof arguments[i] == 'object') {
      ...
      logger2.innerHTML += '<b>' + arguments[i] + '</b><br />'
    }
  }
}
...
const _print_link = function(message, onclickFunction, uuid = ID(), add_carriage = true) {
  ...
  logger2.innerHTML += '<a href="#" id=' + uuid + '>' + message + '</a>'

  if (add_carriage) {
    logger.innerHTML += '<br />'
    logger2.innerHTML += '<br />'
  }
...
const _print_href = function(message, href) {
  ...
  logger2.innerHTML += `<a href="${href}" target="_blank" id="${uuid}">${message}</a><br />`
}
